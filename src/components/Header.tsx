        ...
        <div className="container mx-auto px-3 py-3 lg:py-2 max-w-7xl relative z-[10002] h-full">
          <div className="flex items-center h-full">
            ...
            <div className="flex items-center">
              <img src="/img/comman/logo.webp" alt="L&T Realty Logo" className="h-6 lg:h-8 w-auto" />
            </div>
          ...
          {/* Mobile Navigation - only shows below lg breakpoint AND when menu is open */}
          {isMobile && isMenuOpen && (
              <nav className="mt-4 pb-4 border-t pt-4 relative z-[10001] bg-white shadow-lg">
